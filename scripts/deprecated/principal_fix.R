...
# fix issues
principal$adm_f_name[principal$adm_f_name == "Erika"] <- "Manuela"
principal$adm_l_name[principal$adm_l_name == "Meza"] <- "Colom"
...
#principal$adm_l_name[principal$adm_l_name == "Simpson"] <- "Johnston"
#principal$adm_l_name[principal$adm_l_name == "Johnson"] <- "Johnston"
