...
recipients <- data.frame(first_name = nudge$first_name, 
                         ...
                         spanish_title = nudge$spanish_title,
                         school = nudge$school,
...
for (i in 1:nrow(recipients)){
  rmarkdown::render("source/letter3_spanish_high_average.Rmd", 
                    params = list(
                      ...
                      spanish_title = recipients[i, "spanish_title"],
                    ...
                    output_dir = "output/letters/WillowSP")
}
