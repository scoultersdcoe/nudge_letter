...
params:  
  first_name: "Nayef" 
  last_name: "Al Rumith"
  full_name: "Nayef Al Rumith"
  principal_name: "Bessma Garmo"
  school: "Montgomery Middle School "
  full_address: "1570 Melody Lane El Cajon CA 92019-2015"
  pronoun: his
  day_abs: 10
  times: 6
...
signature: "`r params$principal_name`, Director/a"
...
```{r data, echo=FALSE}
personalized_info <-  readRDS(here("data", "processed", "results_factor_nov_up.rds")) %>%
  filter(date == as.Date("2021-11-01"),
         school == "Montgomery Middle School") %>%
  rename(last_name = first_name,
